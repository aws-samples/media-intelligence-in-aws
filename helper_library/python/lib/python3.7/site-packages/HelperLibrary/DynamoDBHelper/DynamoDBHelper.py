...
class DynamoDBHelper(BaseHelper):
    ...
    def write_to_dynamodb(self,item):
        try:
            ...
            super().log_error("Exception while writing item to DynamoDB \n", e)
            return False
        else:
    ...
    def query_item(self,index_name,condition_expression,condition_attributes,items = "FIRST"):
        try:
            ...
            super().log_error("Exception while getting item from DynamoDB \n",e)
            return False
        else:
    ...
    def get_item(self,primary_key,projection_expression_attributes="",consistent_read = True):
        try:
